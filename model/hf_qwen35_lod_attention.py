"""Legacy Qwen3.5 attention replacement backed by pluggable LOD engines.

The LOD core deliberately starts after QKV projection and positional encoding.
This compatibility module predates the registered Hugging Face LOD backend.
It remains available for Qwen3.5's hybrid linear/softmax cache while the generic
backend in :mod:`hf_pytorch_lod_attention` targets standard decoder caches.
