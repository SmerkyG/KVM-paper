...
from ._config import LODConfig, PagedLODConfig, ROUTE_COUNT
from ._core import TritonLODAttentionCore
...
class KernelTwoLevelLODAttention(_KernelLODEngine):
    ...
    def __init__(
        ...
        *,
        ...
        key_value_heads: int,
        scale: float,
        default_open_count: int = ROUTE_COUNT,
    ) -> None:
...
class KernelRecursivePagedLODAttention(_KernelLODEngine):
    ...
    def __init__(
        ...
        *,
        ...
        self.prefill_two_level_topk = default_open_count
